...
function main(event){
  ...
  if (gamepadopenhome()){
    ...
    apps[id]={"appname":"home","x":rotation_degrees, "y":event.beta,"text":[{"text":()=>{return "CardBoard OS"}, "x": 0, "y": 20, "z": 0}], "el":[{"img": "horloge.png", "x": 20, "y": -50, "z": 0, "color": "black", "w": 1.2, "h": 1.2, "onclick":"clock"},{"img": "color.png", "x": 0, "y": -50, "z": 0, "color": "black", "w": 1.2, "h": 1.2, "onclick":"color"},{"img": "meditation.png", "x": -20, "y": 50, "z": 0, "color": "black", "w": 1.2, "h": 1.2, "onclick":"meditation"},{"img": "settings.svg", "x": -20, "y": -50, "z": 0, "color": "black", "w": 1.2, "h": 1.2, "onclick":"settings"},{"img": "web.png", "x": 20, "y": 50, "z": 0, "color": "black", "w": 1.2, "h": 1.2, "onclick":"web"},{"img": "makeform.png", "x": 0, "y": 50, "z": 0, "color": "black", "w": 1.2, "h": 1.2, "onclick":"makeform"},{"img": "youtube.png", "x": 20, "y": 0, "z": 0, "color": "black", "w": 1.2, "h": 1, "onclick":"youtube"},{"img": "spotify.png", "x": 0, "y": 0, "z": 0, "color": "black", "w": 1.2, "h": 1.2, "onclick":"spotify"},{"img": "app+.svg", "x": -20, "y": 0, "z": 0, "color": "black", "w": 1.2, "h": 1.2, "onclick":"app+"},], "fct":{"clock":(a)=>{openclock(a)}, "color":(a)=>{opencolor(a)}, "meditation":(a)=>{openmindfulness(a)}, "spotify":(a)=>{openspotify(a)}}}
    }
    }
