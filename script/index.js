...
function main(event){
  ...
  for (var i in apps) {
    if (apps.hasOwnProperty(i)) {
      ...
      for (var l = 0; l < apps[i].text.length; l++) {
          ob=apps[i]["text"][l]
          text.push({"text": ob["text"](), "x": ob["x"]+apps[i]["x"], "y": ob["y"]+apps[i]["y"], "z": ob["z"], "size": (ob["size"]) ? ob["size"] : 12, "color": (ob["color"]) ? ob["color"] : "black",  "align": (ob["align"]) ? ob["align"] : "center"})
        }
      }
  }
  ...
  if (gamepadopenhome()){
    ...
    apps[id]={"appname":"home","x":rotation_degrees, "y":leftToRight_degrees*(-3.37)+(339.33),"text":[{"text":()=>{return "CardBoard OS"}, "x": 0, "y": 20, "z": 0}], "el":[{"img": "apps-icon/timerapps.svg", "x": 0, "y": -50, "z": 0, "color": "black", "w": 1.2, "h": 1.2, "onclick":"time"},{"img": "apps-icon/color.png", "x": -20, "y": -50, "z": 0, "color": "black", "w": 1.2, "h": 1.2, "onclick":"color"},{"img": "apps-icon/meditation.png", "x": 20, "y": -50, "z": 0, "color": "black", "w": 1.2, "h": 1.2, "onclick":"meditation"},{"img": "apps-icon/gallery.png", "x": -20, "y": 50, "z": 0, "color": "black", "w": 1.2, "h": 1.2, "onclick":"gallery"},{"img": "apps-icon/news.png", "x": 30, "y": 0, "z": 0, "color": "black", "w": 1.2, "h": 1.2, "onclick":"news"},{"img": "apps-icon/youtube.png", "x": 10, "y": 0, "z": 0, "color": "black", "w": 1.2, "h": 1, "onclick":"youtube"},{"img": "apps-icon/spotify.png", "x": -10, "y": 0, "z": 0, "color": "black", "w": 1.2, "h": 1.2, "onclick":"spotify"},{"img": "apps-icon/app+.svg", "x": -30, "y": 0, "z": 0, "color": "black", "w": 1.2, "h": 1.2, "onclick":"app+"},{"img": "apps-icon/notes.svg", "x": 20, "y": 50, "z": 0, "color": "black", "w": 1.2, "h": 1.2, "onclick":"notes"},{"img": "apps-icon/rappels.svg", "x": 0, "y": 50, "z": 0, "color": "black", "w": 1.2, "h": 1.2, "onclick":"rappels"}, {"img": "apps-icon/keyboardapp.svg", "x": 0, "y": -70, "z": 0, "color": "black", "w": 2.7, "h": 0.5, "onclick":"keyboard"}], "fct":{"clock":(a)=>openclock(a), "color":(a)=>opencolor(a), "meditation":(a)=>openmindfulness(a), "spotify":(a)=>openspotify(a), "gallery":(a)=>opengallery(a), "news":(a)=>opennews(a), "keyboard":(a)=>showkeyboard(a), "chrono":(a)=>openchrono(a), "time":(a)=>opentimebullapp(a), "rappels":(a)=>openrappels(a)}
    }}
    }
